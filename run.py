...
def process_pdb(pdb_path: Path, output_path: Path, scheme: str, fvonly: bool, heavy_only: bool, rename: bool, splitscfv: bool, chain: str, delete_intermediate: bool) -> Path:
...
def process_folder(pdb_path: Path, output_path: Path, scheme: str, fvonly: bool, heavy_only: bool, rename: bool, splitscfv: bool, chain: str, delete_intermediate: bool) -> Path:
    ...
    for child in pdb_path.iterdir():
        ...
        if child.is_dir() and not child.is_symlink() and any(child.iterdir()):
            ...
            process_pdb(child, output_subpath, scheme, fvonly, heavy_only, rename, splitscfv, chain, delete_intermediate)
    return output_path
...
def cli(pdb: str, output: str, scheme: str, fvonly: bool, heavy_only: bool, rename: bool, splitscfv: bool, chain: str, delete_intermediate: bool):
